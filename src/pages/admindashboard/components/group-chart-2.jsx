    ...
    if (statistics) {
      setParsedData([
        ...
        },
        {
          ...
          count: statistics?.mensualGrowthByMoney.toFixed(2) + '%',
          bg: 'bg-[#EAE6FF] dark:bg-slate-900',
          text: statistics?.mensualGrowthByMoney > 0 ? 'text-success-500' : 'text-error-500',
          icon: 'heroicons:arrow-trending-up-solid',
          textColor: statistics?.mensualGrowthByMoney > 0 ? 'text-success-500' : 'text-error-500'
        }
      ])
    }
  }, [statistics])
          ...
          <Card bodyClass='pt-4 pb-3 px-4'>
            <div className='flex space-x-3 rtl:space-x-reverse'>
              ...
              <div className='flex-1'>
                ...
                <div className={`${item.textColor} dark:text-white text-lg font-medium`}>
                  {item.count}
                </div>
              </div>
            </div>
